...
<form method="POST" action="{{url('soal')}}">
	...
	<div class="input-field col s12">
       ...
       <input id="jawab_a" type="text" class="validate" name="jawab_a" value="{{ old('jawab_a') }}">
   	...
   	<div class="input-field col s8">
       <input id="jawab_b" type="text" class="validate" name="jawab_b" value="{{ old('jawab_b') }}">
   	...
   	<div class="input-field col s8">
       <input id="jawab_c" type="text" class="validate" name="jawab_c" value="{{ old('jawab_c') }}">
   	...
   	<div class="input-field col s8">
       <input id="jawab_d" type="text" class="validate" name="jawab_d" value="{{ old('jawab_d') }}">
