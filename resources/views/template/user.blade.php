	...
	<div class="navbar-fixed">
		<nav>
			<div class="nav-wrapper red darken-4">
				...
				<a href="#" class="brand-logo center">ITS_PBO</a>
				<ul id="nav-mobile" class="left hide-on-med-and-down">
					<li @yield('Beranda') ><a href="{{url('mhs/beranda')}}">Beranda</a></li>
					<li @yield('Beranda') ><a href="{{url('mhs/materi')}}">Materi</a></li>
					<li @yield('Beranda') ><a href="{{url('mhs/latihan')}}">Latihan</a></li>
					<li @yield('Beranda') ><a href="{{url('mhs/quiz')}}">Quiz</a></li>
